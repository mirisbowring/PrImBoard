...
func (a *App) InitializeRoutes() {
	...
	a.Router.Handle("/api/v1/media/{id}/comments", a.Authenticate(http.HandlerFunc(a.AddCommentByMediaID), false)).Methods("POST")
	a.Router.Handle("/api/v1/media/{id}/tags", a.Authenticate(http.HandlerFunc(a.AddTagByMediaID), false)).Methods("POST")
